...
class format {
	...
	public static function string_compare($table='', $field='', $match=array(), $type='is') {
		switch ($type) {
			case 'is': $condition = "= '" . $match[0] . "'";
				break;
			case 'regex': $condition = "REGEXP '[[:<:]]" . $match[0] . "[[:>:]]'";
				break;
			case 'like': $condition = "LIKE '%" . $match[0] . "%'";
				break;
			case 'before': $condition = "< '" . $match[0] . "'";
				break;
			case 'before_to': $condition = "<= '" . $match[0] . "'";
				break;
			case 'after': $condition = "> '" . $match[0] . "'";
				break;
			case 'from_after': $condition = ">= '" . $match[0] . "'";
				break;
			case 'between': $condition = "BETWEEN '" . $match[0] . "' AND '" . $match[1] . "'";
				break;
			default: $condition = "= '" . $match[0] . "'";
				break;
		}
	...
	public static function to_sql_condition($array = array()) {
		...
		switch ($condition) {
			case 'is': $sql2 = "= '$condition'";
				break;
			case 'regexp': $sql2 = "REGEXP '[[:<:]]" . $condition . "[[:>:]]'";
				break;
			case 'like': $sql2 = "LIKE '%" . $condition . "%'";
				break;
			case 'in': $sql2 = "IN ('" . implode("','", $condition) . "')";
				break;
			case 'starts': $sql2 = "LIKE '" . $condition . "%'";
				break;
			case 'ends': $sql2 = "LIKE '%" . $condition . "'";
				break;
			case '<': $sql2 = "< '" . $condition . "'";
				break;
			case '<=': $sql2 = "<= '" . $condition . "'";
			...
			case '>': $sql2 = "> '" . $condition . "'";
				break;
			case 'between': $sql2 = "BETWEEN '" . $condition[0] . "' AND '" . $condition[1] . "'";
				break;
			case 'sounds like':
	...
	public static function to_day($daynumber) {
		...
		switch ($daynumber) {
			...
			case 7: $day = 'SATURDAY';
				break;
			case 8: $day = 'NOT_APPLICABLE_SHORT';
				break;
		}
		return $day;
	}
	...
	public static function to_yesno_graphic($bool) {
		return '<img src="/images/' . (($bool == 1) ? 'greenball' : 'redball') . '.gif" alt="' . (($bool == 1) ? 'Yes' : 'No') . '" title="' . (($bool == 1) ? 'Yes' : 'No') . '" />';
	}

	public static function get_package_graphic() {
		return '<img src="/images/icon-package.png" />';
	}
