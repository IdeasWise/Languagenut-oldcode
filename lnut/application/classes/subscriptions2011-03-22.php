...
class subscriptions extends generic_object {
    ...
    public function PaypalIPN() {
		...
		if (strcmp ($res, "VERIFIED") == 0){
                            ...
                            if ($result && mysql_error() == '') {
                                // finally... send an email to the admins that a payment has been completed
                                 if ( !empty($homeuserObject->TableData['vfirstname']['Value'])) {
                                    ...
                                    $email = 'subs@languagenut.com, jamie@languagenut.com, dev@mystream.co.uk, lucy@languagenut.com';
				...
				//mail('swyam.joshi@latitudetechnolabs.com', $pending_subject, $pending_body, 'From: errors@languagenut.com');
