...
class vocabPdf extends FPDF {
	...
	function printFlashCards ($data = array ()) {
		...
		foreach($data['vocab'] as $key=>$val) {
			...
			if($state==0) {
				...
				$this->Image(config::get('pdf_images').'cards_header.jpg', 13, 13, 111);		$this->Image(config::get('pdf_images').'cards_box2.jpg', 14, 40, 111);
				$this->Image(config::get('pdf_images').'cards_header.jpg', 172, 13, 111);		$this->Image(config::get('pdf_images').'cards_foldsymbol.jpg',147,63,5);	$this->Image(config::get('pdf_images').'cards_box2.jpg', 173, 40, 111);
				$this->Image(config::get('pdf_images').'cards_cutline.jpg', 13, 103, 270);
				$this->Image(config::get('pdf_images').'cards_header.jpg', 13, 115, 111);		$this->Image(config::get('pdf_images').'cards_box2.jpg', 14, 143, 111);
				$this->Image(config::get('pdf_images').'cards_header.jpg', 172, 115, 111);	$this->Image(config::get('pdf_images').'cards_foldsymbol.jpg',147,165,5);	$this->Image(config::get('pdf_images').'cards_box2.jpg', 173, 143, 111);
				$state++;
			}
			if($state==1) {
				$u			= $data['unit'];
	...
	function BasicLinear($nvpArray) {
		$this->AddPage();
		$this->Image(config::get('pdf_images').'../images/shared/menu/nowhere.gif',10,8,15);
		$this->Image(config::get('pdf_images').'../images/shared/menu/ccm-word.gif',28,8,10);
		$this->Image(config::get('pdf_images').'../images/shared/menu/ecl-word.gif',42,8,10);
		$this->Image(config::get('pdf_images').'../images/shared/menu/eqs-word.gif',56,8,10);
		$this->Ln(16);
