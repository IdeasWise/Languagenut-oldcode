...
class reseller_sub_package_activity extends generic_object {
	...
	public function saveActivity() {
		...
		if (isset($_POST['submit']) && isset($_POST['package_uid'])) {
			...
			$query = "DELETE ";
			$query.="FROM ";
			$query.="`reseller_sub_package_activity` ";
			$query.="WHERE ";
			$query.="`package_uid` = '" . $_POST['package_uid'] . "' ";
			database::query($query);
			$objPackage = new reseller_sub_package($_POST['package_uid']);
			$objPackage->load();
	...
	public function checkExist($package_uid=null, $reseller_uid=null, $language_uid=null, $activity_uid=null) {
		if ($package_uid != null && $language_uid != null && $activity_uid != null) {
			...
			$query.=" SELECT uid FROM reseller_sub_package RP";
			$query.=" WHERE";
			$query.=" RP.package_uid='{$package_uid}'";
			$query.=" AND RP.reseller_uid='{$reseller_uid}'";
