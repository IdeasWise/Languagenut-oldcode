...
class subscriptions extends generic_object {
	...
	public function CreateSchoolSubscription($user_uid, $price,$makeLive=false) {
	...
	public function PaypalIPN() {
		...
		mail('andrew@languagenut.com', 'languagenut paypal - pre', print_r($_POST, true), 'From: payments@languagenut.com');
		// paypal ipn here
