...
class class_packages extends generic_object {

	public function __construct($uid = 0) {
		parent::__construct($uid, __CLASS__);
	}

	public function AssignPackagesToClass($class_uid=null) {
		if(isset($_POST['assign_now']) && isset($_POST['package']) && count($_POST['package']) && $class_uid!=null) {
			$query ="INSERT INTO ";
	...
	public function getClassActivePackages($class_uid=null,$school_uid=null) {
		if($class_uid!=null) {
			$query ="SELECT * ";
			$query.=" FROM ";
			$query.="`class_packages` ";
