...
//				$arrSchool=(isset($arrSchool))?$arrSchool:array();
	...
	private function isValidateFormData() {
		...
		if ($this->isValidarrFields($arrFields, $this) === true) {
			...
			$this->set_notes_2wft_call1($arrFields['notes_2wft_call1']['value']);
			$this->set_notes_2wft_call2($arrFields['notes_2wft_call2']['value']);
			$this->set_notes_2wft_call3($arrFields['notes_2wft_call3']['value']);
			$this->set_notes_courtesy_call1($arrFields['notes_courtesy_call1']['value']);
			$this->set_notes_courtesy_call2($arrFields['notes_courtesy_call2']['value']);
			$this->set_notes_renewal_call1($arrFields['notes_renewal_call1']['value']);
			$this->set_notes_renewal_call2($arrFields['notes_renewal_call2']['value']);
