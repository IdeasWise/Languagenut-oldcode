...
class account_flash_translations extends Controller {
	...
	protected function index() {
		...
		if(count($_POST) > 0) {
			...
			output::redirect(config::url('account/flash_translations/'));
		}

		$skeleton				= make::tpl('skeleton.account.translator');
		$support_language_uid	= 14;
		$body					= make::tpl('body.account.flash_translations.list');
		 ...
		 * Fetch Locales
		 */
		$prefixes = profile_translator::getPrefixes();
