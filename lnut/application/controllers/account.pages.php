...
class account_pages extends Controller {
	...
	public function __construct () {
		...
		if(isset($parts[2]) && in_array($parts[2], $this->pages)) {
			$this->selected	 = $parts[2];
		}
	...
	protected function doSchoolStage() {
		...
		$body->assign(
			array(
				'section_name'=>'School Registration'
			)
		);
	...
	protected function doHomeuserStage() {
		...
		$body->assign(
			array(
				'section_name'=>'Home User Registration'
			)
		);
