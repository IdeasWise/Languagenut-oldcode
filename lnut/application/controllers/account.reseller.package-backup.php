	...
	private function getLanguages() {
		if(is_array($this->json_languages) && count($this->json_languages)) {
			...
			if (is_array($arrLanguages) && count($arrLanguages)) {
				...
				$clickableOnOff = '<a class="admin-select-all" href="#" ';
				$clickableOnOff.= 'onclick="';
				$clickableOnOff.= "if($(this).attr('rel')=='off'){";
				$clickableOnOff.= "$('input[type=checkbox]').attr('checked','checked');";
				$clickableOnOff.= "$(this).attr('rel','on');$(this).html('Deselect All');";
				$clickableOnOff.= "}else{";
				$clickableOnOff.= "$('input[type=checkbox]').attr('checked',false);";
				$clickableOnOff.= "$(this).attr('rel','off');$(this).html('Select All');";
				$clickableOnOff.= "}";
				$clickableOnOff.= "return false;";
				$clickableOnOff.= '" rel="off">Select All</a>';
